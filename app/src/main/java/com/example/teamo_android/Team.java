...
public class Team {
    ...
    Team(int id, String title, String leaderName, int memberNum, String subject, String semester, String professor, int courseClass) {
        this.id = id;
        this.title = title;
    ...
    private String makeContent(String subject, String semester, String professor, int courseClass) {
    ...
    public int getCourseClass() { return this.courseClass; }
    ...
    public void setCourseClass(int num) { this.courseClass = num; }

    public void setContent(String subject, String semester, String professor, int courseClass) {
